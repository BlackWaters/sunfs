...
static inline unsigned long fpte_vaddr(fpte_t *fpte)
{
 ...
 */
static inline void fpmd_populate(fpmd_t *fpmd, fpte_t *fpte)
{
 ...
 */
static inline void fpte_populate(fpte_t *fpte, unsigned long vaddr)
{
